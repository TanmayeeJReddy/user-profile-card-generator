...
// Step 4: Dynamically generate and render the Profile Card
app.post('/create-profile', async (req, res) => {
    try {
        const { name, bio, skills, github, linkedin } = req.body;

        // Clean & process skills string into an array
        ...
        await db.run(
            ...
            [name.trim(), bio.trim(), formattedSkills, github, linkedin]
        );

        // Generate skill pill elements dynamically
        ...
        // Send back dynamic HTML response
        res.send(`
            <!DOCTYPE html>
            <html lang="en">
            <head>
